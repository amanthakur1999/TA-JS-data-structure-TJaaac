...
console.log(person2.firstName); // Aray
console.log(person.firstName); // Aray
...
console.log(person.address == personTwo.address); // false
console.log(personTwo.address.city); // San John
console.log(person.address.city); // San John
...
// Your code goes here
let clonedPerson=JSON.parse(JSON.stringfy(person))
```
